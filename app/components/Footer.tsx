...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: <MdPhone className="w-5 h-5" />, label: 'Phone', value: '+880 1335 167 729', link: 'tel:+880 1335 167 729' },
    { icon: <MdEmail className="w-5 h-5" />, label: 'Email', value: 'info@bdauto.com.bd', link: 'mailto:info@bdauto.com.bd' },
